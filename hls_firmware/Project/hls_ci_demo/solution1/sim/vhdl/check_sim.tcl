...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Sort_top.autotvin_a_0.dat"
         "c.Sort_top.autotvin_a_1.dat"
         "c.Sort_top.autotvin_a_2.dat"
         "c.Sort_top.autotvin_a_3.dat"
         "c.Sort_top.autotvin_a_4.dat"
         "c.Sort_top.autotvout_b_0.dat"
         "c.Sort_top.autotvout_b_1.dat"
         "c.Sort_top.autotvout_b_2.dat"
         "c.Sort_top.autotvout_b_3.dat"
         "c.Sort_top.autotvout_b_4.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Sort_top.autotvout_b_0.dat"
         "rtl.Sort_top.autotvout_b_1.dat"
         "rtl.Sort_top.autotvout_b_2.dat"
         "rtl.Sort_top.autotvout_b_3.dat"
         "rtl.Sort_top.autotvout_b_4.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
