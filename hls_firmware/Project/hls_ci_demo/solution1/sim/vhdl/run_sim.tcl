...
if {[file isfile Sort_top.autotvin.dat]} {
	file delete -force Sort_top.autotvin.dat
}

if {[file isfile Sort_top.autotvout.dat]} {
	file delete -force Sort_top.autotvout.dat
}
