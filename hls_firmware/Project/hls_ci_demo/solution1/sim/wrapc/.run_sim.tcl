...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/mghorbani/Xilinx/Vivado/2020.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mghorbani/Xilinx/Vivado/2020.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mghorbani/Xilinx/Vivado/2020.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/mghorbani/Xilinx/Vivado/2020.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Sort_top.autotvin.dat"
	set constFileTvOut       "Sort_top.autotvout.dat"
	set constFileHdlTvIn     "Sort_top.autohdltvin.dat"
	set constFileHdlTvOut    "Sort_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
